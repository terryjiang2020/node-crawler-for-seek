...
const BASE_URL = 'https://www.indeed.com/jobs?q=' + keywords + '&fromage=14';
...
(async () => {
    ...
    var file = path.join(__dirname, 'indeed-us-general.json'); 
...
async function pageLoader(url) {
    ...
    if (
        ...
        const next = 'https://www.indeed.com' + $('.pagination-list li').eq(-1).find('a').attr('href');
        sleep.sleep(2);
